...
class PileDetector:
    ...
    def _visualize_action_command(self, image: Image.Image, detections: List[PilePosition], 
    ...
    def visualize_actions(self, image_path: str, detections: List[PilePosition], 
        ...
        try:
            image = Image.open(image_path)
            return self._visualize_action_command(image, detections, action_commands, output_path)
        except Exception as e:
